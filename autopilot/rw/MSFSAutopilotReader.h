#ifndef MSFS_CONTROLLER_MSFSAUTOPILOTREADER_H
#define MSFS_CONTROLLER_MSFSAUTOPILOTREADER_H
...
class MSFSAutopilotReader : public AutopilotReader {
    HANDLE* connection;
...
public:
    MSFSAutopilotReader(HANDLE* connection) {
        ...
        // double vNavState;
        this->running = true;
        this->workerThread = std::thread(&MSFSAutopilotReader::threadLoop, this);
    }
...
#endif //MSFS_CONTROLLER_MSFSAUTOPILOTREADER_H
